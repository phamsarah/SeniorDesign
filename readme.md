...
- Confirmations and Invoices sent from the SendSaveAll function don't create the pdfs for documents after the first. This comments on a possible easy fix to this can be found above the ConfirmationOrInvoice function. It seemed to be working prior to a refactor so referencing team4's github may prove useful.
